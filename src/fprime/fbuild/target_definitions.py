...
from .enumerator import BasicBuildTargetEnumerator,MultiBuildTargetEnumerator, RecursiveMultiBuildTargetEnumerator, SpecificBuildTargetEnumerator, CliBuildTargetEnumerator
...
Target.register_target(BuildSystemTarget(
    ...
    # This target will enumerate all build targets in the current directory
    build_target_enumerator=MultiBuildTargetEnumerator(fail_safe_enumerator=BasicBuildTargetEnumerator("ut_exe"))
))
Target.register_target(BuildSystemTarget(
    mnemonic="build",
...
Target.register_target(CheckTarget(
    mnemonic="check",
    ...
    build_target_enumerators=[check_multi_build_enumerator, check_multi_test_enumerator]
))
...
Target.register_target(CheckTarget(
    ...
    build_target_enumerators=[
        RecursiveMultiBuildTargetEnumerator(directory_enumerator=check_multi_build_enumerator),
        RecursiveMultiBuildTargetEnumerator(directory_enumerator=check_multi_test_enumerator)
    ]
))
Target.register_target(CheckTarget(
    mnemonic="check",
...
Target.register_target(GcovrTarget(
    mnemonic="check",
